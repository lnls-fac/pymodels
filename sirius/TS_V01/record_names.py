...
def get_element_names(accelerator, element = None, prefix='', suffix=''):
    ...
    if element.lower() == 'septa' or element.lower() == 'sep':
        _dict ={
            ...
            prefix + 'SEPTUMTHICK-04' + suffix : {'septing' : [family_data['septing']['index'][0]]},
            prefix + 'SEPTUMTHIN-04'  + suffix : {'septinf' : [family_data['septinf']['index'][0]]},
        }
        return _dict
    ...
    if element.lower() == 'hcm':
        ...
        _dict = {
            prefix + 'CH-01' + suffix : {'hcm' : [indices[0]]},
            prefix + 'CH-02' + suffix : {'hcm' : [indices[1]]},
            prefix + 'CH-03' + suffix : {'hcm' : [indices[2]]},
            prefix + 'CH-04' + suffix : {'hcm' : [indices[3]]},
        }
        return _dict
    ...
    if element.lower() == 'vcm':
        ...
        _dict = {
            prefix + 'CV-01-A' + suffix : {'vcm' : [indices[0]]},
            prefix + 'CV-01-B' + suffix : {'vcm' : [indices[1]]},
            prefix + 'CV-02'   + suffix : {'vcm' : [indices[2]]},
            prefix + 'CV-03'   + suffix : {'vcm' : [indices[3]]},
            prefix + 'CV-04-A' + suffix : {'vcm' : [indices[4]]},
            prefix + 'CV-04-B' + suffix : {'vcm' : [indices[5]]},
        }
        return _dict
