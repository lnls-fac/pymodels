...
def create_lattice(mode='S10',version='01'):
    ...
    SDBA0 = sextupole('sdba0', 0.150, strengths['sdba0']) # CH-CV
    SDBP0 = sextupole('sdbp0', 0.150, strengths['sdbp0']) # CH-CV
    SDP0  = sextupole('sdp0',  0.150, strengths['sdp0'])  # CH-CV
    SDA1  = sextupole('sda1',  0.150, strengths['sda1'])  # QS
    SDBA1 = sextupole('sdba1', 0.150, strengths['sdba1']) # QS
    SDBP1 = sextupole('sdbp1', 0.150, strengths['sdbp1']) # QS
    SDP1  = sextupole('sdp1',  0.150, strengths['sdp1'])  # QS
    SDA2  = sextupole('sda2',  0.150, strengths['sda2'])  # CH-CV
    SDBA2 = sextupole('sdba2', 0.150, strengths['sdba2']) # CH-CV
    SDBP2 = sextupole('sdbp2', 0.150, strengths['sdbp2']) # CH-CV
    SDP2  = sextupole('sdp2',  0.150, strengths['sdp2'])  # CH-CV
    SDA3  = sextupole('sda3',  0.150, strengths['sda3'])  # --
    SDBA3 = sextupole('sdba3', 0.150, strengths['sdba3']) # --
    SDBP3 = sextupole('sdbp3', 0.150, strengths['sdbp3']) # --
    SDP3  = sextupole('sdp3',  0.150, strengths['sdp3'])  # --
    SFA0  = sextupole('sfa0',  0.150, strengths['sfa0'])  # CV
    SFBA0 = sextupole('sfba0', 0.150, strengths['sfba0']) # CV
    SFBP0 = sextupole('sfbp0', 0.150, strengths['sfbp0']) # CV
    SFP0  = sextupole('sfp0',  0.150, strengths['sfp0'])  # CV
    SFA1  = sextupole('sfa1',  0.150, strengths['sfa1'])  # QS
    SFBA1 = sextupole('sfba1', 0.150, strengths['sfba1']) # QS
    SFBP1 = sextupole('sfbp1', 0.150, strengths['sfbp1']) # QS
    SFP1  = sextupole('sfp1',  0.150, strengths['sfp1'])  # QS
    SFA2  = sextupole('sfa2',  0.150, strengths['sfa2'])  # CH
    SFBA2 = sextupole('sfba2', 0.150, strengths['sfba2']) # CH-CV
    SFBP2 = sextupole('sfbp2', 0.150, strengths['sfbp2']) # CH
    ...
    M2BA   = M1BA[::-1]                                                                                # low beta xxM2 girder
    M2BP   = M1BP[::-1]                                                                                # low beta xxM2 girder
