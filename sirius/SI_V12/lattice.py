...
def create_lattice():
    ...
    C2A = [GIR,L460,GIR,SD3J,L170,QF3,L230,SF2J,L077,CF,L083,QF4,GIR,L533,GIR,CV,L105,BPM,RBPM,L100]           # arc sector in between B2-BC (high beta odd-numbered straight sections)
    ...
    C2B = [GIR,L460,GIR,SD3K,L170,QF3,L230,SF2K,L077,CF,L083,QF4,GIR,L533,GIR,CV,L105,BPM,RBPM,L100]           # arc sector in between B2-BC (low beta even-numbered straight sections)
    ...
    C2A_DCCT = [GIR,L460,GIR,SD3J,L170,QF3,L230,SF2J,L077,CF,L083,QF4,GIR,L304,DCCT1,L229,GIR,CV,L105,BPM,RBPM,L100]  # arc sector in between B2-BC with DCCT1 (high beta odd-numbered straight sections)
    C2B_DCCT = [GIR,L460,GIR,SD3K,L170,QF3,L230,SF2K,L077,CF,L083,QF4,GIR,L304,DCCT2,L229,GIR,CV,L105,BPM,RBPM,L100]  # arc sector in between B2-BC with DCCT2 (low beta even-numbered straight sections)
