...
def get_optics_mode(optics_mode):
    ...
    if optics_mode == 'M1':
        ...
        twiss_at_match = _pyaccel.optics.Twiss.make_new(beta=[7.0,7.0], alpha=[0.0,0.0])
    elif optics_mode == 'M2':
        strengths = {
            'qf2' :   9.831704524983,
            'qd2' :  -4.217071772967,
        ...
        twiss_at_match = _pyaccel.optics.Twiss.make_new(beta=[10.0,10.0], alpha=[0.0,0.0])
    elif optics_mode == 'M3':
        strengths = {
            'qf2' :  11.497289971737,
            'qd2' :  -4.009053542903,
        ...
        twiss_at_match = _pyaccel.optics.Twiss.make_new(beta=[7.0,7.0], alpha=[-1.0,-1.0])
    elif optics_mode == 'M4':
        strengths = {
            'qf2' :   3.534340054347,
            'qd2' :  -6.58275439308,
