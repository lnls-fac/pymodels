...
def get_optics_mode(optics_mode):
    ...
    if optics_mode == 'M1':
        ...
        strengths = {
            ...
            'qf4': 2.725105900082,
            'qd4b': -0.178371654879,
            'ejeseptf_kxl': factor1*gradx,
            'ejeseptf_kyl': factor1*grady,
            'ejeseptf_ksxl': 0.0,
            'ejeseptf_ksyl': 0.0,
            'ejeseptg_kxl': factor1*gradx,
            'ejeseptg_kyl': factor1*grady,
            'ejeseptg_ksxl': 0.0,
            'ejeseptg_ksyl': 0.0,
            'injseptg_kxl': factor2*gradx,
            'injseptg_kyl': factor2*grady,
            'injseptg_ksxl': 0.0,
            'injseptg_ksyl': 0.0,
            'injseptf_kxl': factor2*gradx,
            'injseptf_kyl': factor2*grady,
            'injseptf_ksxl': 0.0,
            'injseptf_ksyl': 0.0,
        }
    elif optics_mode == 'M5':
